...
if numthreeanswer.lower() == "a" or
    print("wrong")
elif numthreeanswer.lower() == "b":
    print("correct")
    score += 1
elif numthreeanswer.lower() == "c":
...
if numfouranswer.lower() == "a":
    print("nope")
elif numfouranswer.lower() == "b":
    print("correct")
    score += 1
elif numfouranswer.lower() == "c":
...
if numfiveanswer.lower() == "a":
    print("same, but wrong")
elif numfiveanswer.lower() == "b":
    print("what, why?")
elif numfiveanswer.lower() == "c":
    print("sounds yummy, but im a computer not a cook")
elif numfiveanswer.lower == "d":
    print("correct")
    score += 1
else:
    print("wrong")
